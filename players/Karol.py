...
class ConservativeBot(PokerBotAPI):    
    def __init__(self, name: str):
        ...
        self.premium_hands = [
            ...
            (Rank.EIGHT, Rank.EIGHT), (Rank.ACE, Rank.KING), (Rank.ACE, Rank.QUEEN), 
            (Rank.ACE, Rank.JACK),(Rank.KING, Rank.QUEEN), (Rank.KING, Rank.JACK), (Rank.QUEEN, Rank.JACK)
        ]
    ...
    def get_action(self, game_state: GameState, hole_cards: List[Card], 
        ...
        is_high_pocket_pair = (card1.rank == card2.rank and 
                              card1.rank.value >= 10)  # 10s or better
